...
import myapi.myapicommon.model.enums.InterfaceInfoStatusEnum;
...
//        interfaceInfo.setId(loginUser.getId());
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        String username = myApiClient.postInterface("", oldInterfaceInfo);
    ...
    public BaseResponse<String> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        String usernameByPost = tempClient.postInterface(userRequestParams, oldInterfaceInfo);
